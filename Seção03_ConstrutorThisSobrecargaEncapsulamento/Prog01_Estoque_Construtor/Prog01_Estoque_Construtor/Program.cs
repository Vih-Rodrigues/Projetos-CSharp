...
namespace Prog01_Estoque_Construtor
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            quantidade_auxiliar = int.Parse(Console.ReadLine());

            // Chamada da classe passando os parâmetros obrigatórios para o construtor na classe
            produto_main = new Produto(nome_auxiliar, preco_auxiliar, quantidade_auxiliar);
